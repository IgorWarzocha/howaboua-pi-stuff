...
- extensions: `pi-ask`, `pi-auto-trees`, `pi-cache-hit-predictor`, `pi-dynamic-tools`, `pi-explore-subagents`, `pi-gippity-control`, `pi-gpt-switcher`, `pi-memories`, `pi-pet`, `pi-semantic-grep`, `pi-shepherdr`, `pi-skills-tool`, `pi-smart-btw`, `pi-subagent-review`, `pi-unicode-charts`, and `pi-vent`
