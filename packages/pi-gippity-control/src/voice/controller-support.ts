...
export const VOICE_STATUS_KEY = "gippity-voice";
...
export function voiceModeForState(
	state: Exclude<VoiceState, { type: "idle" } | { type: "failed" }>,
): CodexVoiceMode {
...
export function prepareRealtimeVoicePrompt(
