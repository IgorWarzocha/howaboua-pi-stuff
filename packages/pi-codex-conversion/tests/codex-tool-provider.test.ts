...
test("resolveCodexApiProviderBaseUrl mirrors Codex provider base shape", () => {
	assert.equal(resolveCodexApiProviderBaseUrl("https://chatgpt.com/backend-api/codex/responses"), "https://chatgpt.com/api/codex");
	assert.equal(resolveCodexApiProviderBaseUrl("https://chatgpt.com/backend-api/codex"), "https://chatgpt.com/api/codex");
	assert.equal(resolveCodexApiProviderBaseUrl("https://chatgpt.com/backend-api"), "https://chatgpt.com/api/codex");
...
test("resolveCodexAlphaSearchUrl appends alpha/search to provider base", () => {
	...
	assert.equal(resolveCodexAlphaSearchUrl("https://chatgpt.com/backend-api/codex/responses"), "https://chatgpt.com/api/codex/alpha/search");
});
