...
function buildCodexGuidelines(mode = "normal", tools = {}) {
    if (mode !== "path")
        return [...NORMAL_CODEX_GUIDELINES];
    const guidelines = [...PATH_CODEX_GUIDELINES];
    const examples = [`- apply_patch <<'PATCH'`, `  *** Begin Patch`, `  ...`, `  *** End Patch`, `  PATCH`];
    if (tools.viewImage !== false)
        examples.push(`- view_image '{"path":"/x.png"}'`);
...
function injectGuidelines(prompt, mode, tools) {
