...
function stripTerminalControlSequences(text, preserveCsi = false) {
...
function sanitizeBinaryOutput(text, preserveBackspace = false) {
...
function writeTerminalChar(session, char) {
...
export function applyTerminalOutput(session, text) {
...
function computePtyDelta(previous, current) {
...
export function truncateOutput(text, maxOutputTokens) {
    if (text.length === 0)
        return { output: "" };
...
export function peekOutputSince(session, baseline, maxOutputTokens) {
