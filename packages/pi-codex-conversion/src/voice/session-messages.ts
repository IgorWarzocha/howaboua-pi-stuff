...
import { renderRealtimeDelegation, renderRealtimeTranscriptTail } from "./prompts.ts";
...
const DICTATION_TURN_CONTEXT_TYPE = "codex-dictation-turn";
...
export class CodexVoiceSessionMessages {
	...
	prepareDictationTurn(): void {
		this.pi.sendMessage({
			...
			content: "<codex_dictation>Next user prompt was dictated and may contain recognition errors or missing punctuation.</codex_dictation>",
			display: false,
			details: {},
		}, { triggerTurn: false, deliverAs: "nextTurn" });
	}
