...
- Post-start transport recovery intentionally uses three fresh WebSocket attempts, then SSE on Pi's final retry; a successful recovery reopens the WebSocket cache lane for later turns.
