...
- Pi transcript API: `e4c75a732` (source checkout; published `0.85.1` does not contain this API)
...
- Chronological system sections and tool declarations, with replacement collapse for incompatible transcripts
