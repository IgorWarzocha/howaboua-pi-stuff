...
id: clawa
display_name: Clawa
style: rounded illustrated mascot
source_format: codex-v2
---

# Clawa

A cheerful orange compile-spirit fox with a cream face and belly, lightning tail, and teal codefire paws.
...
`idle`, `running-right`, `running-left`, `waving`, `jumping`, `failed`, `waiting`, `running`, `review`, and sixteen pointer-look directions. Pi Pet also provides the semantic aliases `active`, `working`, `thinking`, `settled`, `success`, `error`, and `hello`.
