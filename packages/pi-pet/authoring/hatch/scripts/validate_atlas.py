...
# Modified from the Apache-2.0 Hatch Pet workflow for current Pillow pixel access.
...
def main() -> None:
    ...
    supported_row_count = row_count in {ROWS, EXTENDED_ROWS}
    for row_index in range(row_count if supported_row_count else 0):
