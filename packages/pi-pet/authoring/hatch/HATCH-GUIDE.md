...
- Run `bun <pi-pet-package>/scripts/validate-pet.mjs <absolute-package-directory>`. Follow `../PET-GUIDE.md`'s **Rebuild and load** procedure, then inspect at display scale and exercise every standard action.
