...
- Durable package under `$PET_DATA/pets/<pet-id>` contains inert bounded files only and passes `npm run pet:validate -- $PET_DATA/pets/<pet-id>` from the installed Pi Pet package root.
