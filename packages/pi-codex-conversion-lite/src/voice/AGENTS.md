...
- LAN voice is session-owned: one lazy V3 conversation, short-lived V2 dictation, server draft, replaceable browser audio. Takeover stops the old mic without restarting V3.
