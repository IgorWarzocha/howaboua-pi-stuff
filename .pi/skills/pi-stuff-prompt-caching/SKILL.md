...
Read `references/codex-pi-map.md` for this repository's request construction, Code Mode, continuation, prewarm, compaction, and voice boundaries. Recheck current provider documentation before relying on mutable cache API behavior.
