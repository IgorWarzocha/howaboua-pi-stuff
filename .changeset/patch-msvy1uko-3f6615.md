...
Run Pi Pet as a first-class GipPity companion.
...
- Attach displays through Pi-owned SSH sessions that reuse `~/.pi/agent/pi-pet` without installing an app or enabling background startup.
