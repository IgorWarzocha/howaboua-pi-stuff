...
- New tabs open in the background and keep rendering during control. Show them explicitly, list session-owned tabs, and close only those owned by the current Pi session.
