...
- Add experimental no-summary context management with native history/notes namespaces, local Pi persistence, hybrid Codex backend fallback, budget reminders, and Code/Notebook controls.
