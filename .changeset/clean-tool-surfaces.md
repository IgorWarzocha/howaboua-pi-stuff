...
Add a Codex tools override for proxied providers, enabled by default, so Codex proxy users can choose whether listed providers receive optional native web search and image generation tools.
